...
void Renderer::drawUi(const SolarSystem& system, const Camera& camera, const SimulationSettings& settings, int selectedIndex, const Spacecraft& spacecraft, UiOverlay& ui, int width, int height, float fps, bool showHelp) {
    ...
    ui.drawText(24.0f, 214.0f, 1.0f, glm::vec4(0.84f, 0.92f, 1.0f, 0.64f), "DEVELOPED BY ");
    float devWidth = ui.textWidth("DEVELOPED BY ", 1.0f);
    ui.drawText(24.0f + devWidth, 214.0f, 1.0f, glm::vec4(0.84f, 0.92f, 1.0f, 0.64f), "ESTIUK ARAFAT ARNOB");
    ui.drawText(24.0f + devWidth + 1.0f, 214.0f, 1.0f, glm::vec4(0.84f, 0.92f, 1.0f, 0.64f), "ESTIUK ARAFAT ARNOB");
    ...
    if (showHelp) {
        ...
        ui.drawText(helpX + 20.0f, helpY + 428.0f, 1.12f, glm::vec4(0.84f, 0.92f, 1.0f, 0.68f), "DEVELOPED BY ");
        float devHelpWidth = ui.textWidth("DEVELOPED BY ", 1.12f);
        ui.drawText(helpX + 20.0f + devHelpWidth, helpY + 428.0f, 1.12f, glm::vec4(0.84f, 0.92f, 1.0f, 0.68f), "ESTIUK ARAFAT ARNOB");
        ui.drawText(helpX + 20.0f + devHelpWidth + 1.0f, helpY + 428.0f, 1.12f, glm::vec4(0.84f, 0.92f, 1.0f, 0.68f), "ESTIUK ARAFAT ARNOB");
